...
describe Redleaf::NodeConversion do
	...
	it "converts an xsd:string to a String" do
		Redleaf::NodeConversion.make_typed_literal_object( XSD[:string], "a string" ).should == 'a string'
	end


	it "converts an xsd:float to a Float" do
		Redleaf::NodeConversion.make_typed_literal_object( XSD[:float], "2.1415" ).should == 2.1415
	end

	it "converts an xsd:decimal to a BigDecimal" do
		Redleaf::NodeConversion.make_typed_literal_object( XSD[:decimal], "2.1415" ).should == 2.1415
	end

	it "converts an xsd:integer to a Integer" do
		Redleaf::NodeConversion.make_typed_literal_object( XSD[:integer], "18" ).should == 18
	end
	...
	it "converts an xsd:duration to a Duration" do
		Redleaf::NodeConversion.make_typed_literal_object( XSD[:duration], "P1Y2M3DT10H30M" ).should == 
	...
	it "converts an xsd:duration with a decimal seconds value to an equivalent Duration" do
		Redleaf::NodeConversion.make_typed_literal_object( XSD[:duration], "PT8M3.886S" ).should == 
